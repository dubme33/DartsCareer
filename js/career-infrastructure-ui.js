const CAREER_INFRASTRUCTURE_TEXT = {
    pl: {
        title: '✈️ Baza treningowa i podróże', tile: '✈️ Baza i podróże',
    ...
    en: {
        title: '✈️ Training base & travel', tile: '✈️ Base & travel',
    ...
    nl: {
        title: '✈️ Trainingsbasis & reizen', tile: '✈️ Basis & reizen', tileNoBase: 'Voorbereiding {preparation}/100 · geen eigen basis', tileBase: 'Voorbereiding {preparation}/100 · onderhoud {maintenance}/mnd', intro: 'Langdurige investeringen buiten de basis-OVR. De basis bouwt voorbereiding op; de reisstandaard bepaalt kosten en vermoeidheid voor het volgende toernooi.',
